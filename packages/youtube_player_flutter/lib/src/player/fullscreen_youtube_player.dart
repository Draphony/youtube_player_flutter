...
class _FullScreenYoutubePlayerState extends State<_FullScreenYoutubePlayer> {
  ...
  Widget build(BuildContext context) {
    return YoutubePlayer(
      ...
      actionsPadding: widget.actionsPadding ?? const EdgeInsets.all(8.0),
      bottomActions: widget.bottomActions,
      bufferIndicator: widget.bufferIndicator,
      controlsTimeOut: widget.controlsTimeOut ?? const Duration(seconds: 3),
      liveUIColor: widget.liveUIColor ?? Colors.red,
